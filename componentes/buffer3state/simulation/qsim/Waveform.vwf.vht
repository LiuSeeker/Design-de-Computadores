...
-- *****************************************************************************
-- Generated on "08/30/2019 10:30:38"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          buffer3state
-- 
...
ENTITY buffer3state_vhd_vec_tst IS
END buffer3state_vhd_vec_tst;
ARCHITECTURE buffer3state_arch OF buffer3state_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL entrada : STD_LOGIC_VECTOR(7 DOWNTO 0);
SIGNAL hab : STD_LOGIC;
SIGNAL output : STD_LOGIC_VECTOR(7 DOWNTO 0);
COMPONENT buffer3state
	PORT (
